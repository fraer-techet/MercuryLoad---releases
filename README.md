...
namespace MacDock
{
    // Добавили значки "?", чтобы сказать системе: "Да, мы знаем, что иконки может не быть, не паникуй"
    ...
    public partial class MainWindow : Window
    {
        ...
        private ImageSource? GetIconFromFile(string filePath)
        {
            try
            {
                // ВОТ ИСПРАВЛЕНИЕ: Мы жестко указали "System.Drawing.Icon", чтобы система не путала его с иконкой окна
        ...
        private async void AppIcon_Click(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            if (app != null && border != null)
            {
                ...
                // Защита от пустоты (чтобы компилятор не ругался)
