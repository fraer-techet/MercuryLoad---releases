                ...
                <ItemsControl.ItemTemplate>
                    <DataTemplate>
                        <StackPanel Margin="6,0,6,0" VerticalAlignment="Bottom">
                            ...
                            <!-- ИКОНКА (Убрал жесткую ширину, чтобы она могла анимироваться) -->
                            <Border Height="40" Cursor="Hand" MouseLeftButtonUp="AppIcon_Click"
                                ...
                                <Border.Style>
                                    <Style TargetType="Border">
                                        ...
                                        <Style.Triggers>
                                            ...
                                            <!-- АНИМАЦИЯ ПОЯВЛЕНИЯ (Плавное расширение дока) -->
                                            <EventTrigger RoutedEvent="Loaded">
                                                <BeginStoryboard>
                                                    <Storyboard>
                                                        <DoubleAnimation Storyboard.TargetProperty="Width" From="0" To="40" Duration="0:0:0.25">
